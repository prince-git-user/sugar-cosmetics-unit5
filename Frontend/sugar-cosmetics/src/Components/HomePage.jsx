...
const HomePage = () => {
  return (
    <>
      ...
      <Slider/>
     <div ><h1 className="h1-tag-div">REFER YOUR FRIENDS</h1></div>
     <img src="https://sugar-mobile-application.s3-ap-south-1.amazonaws.com/f53f2d67-ea43-4959-abca-eba6d87fd598.jpg" alt="sugar.png"/>
     <div ><h1 className="h1-tag-div" >METTLE PRIMING BALM</h1></div>
     ...
     <div ><h1 className="h1-tag-div">QUICK BEAUTY TIPS WITH SUGAR</h1></div>
     <Slider2/>
     <div ><h1 className="h1-tag-div" >HOT DEALS</h1></div>
     ...
     <div ><h1 className="h1-tag-div" >ULTIMATE MAKEUP QUIZ</h1></div>
     <img src="https://d32baadbbpueqt.cloudfront.net/55b14ff1-ff6e-4af7-bbb6-9dbe8771037f.jpg" alt="ultimate.png"/>

     <div ><h1 className="h1-tag-div" >TOP PICKS OF THE WEEK</h1></div>
     ...
     <div className="hot-deals">
      ...
      {/* <div className="EXplore">
        <img className="explore-image" src="https://sugar-mobile-application.s3-ap-south-1.amazonaws.com/3d719924-5511-4ebb-b31f-dc3fabbe4cb1.jpg"/>
        <img className="explore-image" src="https://sugar-mobile-application.s3-ap-south-1.amazonaws.com/887ac04a-d449-4793-b6ef-f7dfddf1a214.jpg"/>
        <img className="explore-image" src="https://sugar-mobile-application.s3-ap-south-1.amazonaws.com/3fd3b743-7482-48aa-b08c-e2945f4e55ee.jpg"/>
        <img className="explore-image" src="https://sugar-mobile-application.s3-ap-south-1.amazonaws.com/44351c32-e291-4ef3-9b12-c8570d2d369e.jpg"/>
     </div> */}
